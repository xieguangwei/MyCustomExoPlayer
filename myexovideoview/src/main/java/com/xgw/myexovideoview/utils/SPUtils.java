...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        if (MyExoVideoManager.getInstance().getApp() == null) {
            throw new UnsupportedOperationException("请先在application的oncreate里面执行MyExoVideoManager.getInstance().initApp(this)");
        }
        sp = MyExoVideoManager.getInstance().getApp().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
